...
class WindowOpt:
    ...
    def Screen_Shot(self, filename=None):
        if filename is None:
            ...
            filename = f'C:/Users/dmvac/OneDrive/Pictures/Screenshots{randint(1, 100)}.jpg'
        else:
            # Add the .jpg extension if missing
        ...
        try:
            ...
            return filename  # Return the filename after saving the screenshot
...
def open_task_manager():
    try:
        ...
        print("Error: Task Manager not found.")