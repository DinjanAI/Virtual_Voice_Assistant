...
# load trained model
model = load_model('D:/Project/Virtual-Voice-Assistant-main/Data/chat_model')

# load tokenizer object
with open('D:/Project/Virtual-Voice-Assistant-main/Data/tokenizer.pickle', 'rb') as handle:
    tokenizer = load(handle)

# load label encoder object
with open('D:/Project/Virtual-Voice-Assistant-main/Data/label_encoder.pickle', 'rb') as enc:
...
def main(query):
        ...
        if intent == "joke" and "joke" in query:
            ...
            win_ops.Screen_Shot()
            speak("Screenshot takes Successfully")
            done = True
        elif intent == "task manager" and "task manager" in query:
            stats = open_task_manager()
            speak(stats)
            done = True
